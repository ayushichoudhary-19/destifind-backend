...
async function fetchData(preferences, budget, numTravelers, month) {
  const prompt = `Discover your ideal travel destination based on your preferences. Plan your trip with a budget of Rs${budget} for  ${numTravelers} travelers in INR, intending to travel in the month of ${month}.Your main preferences are ${preferences}.Immerse yourself in breathtaking scenic landscapes, embrace rich cultural experiences, and explore thrilling adventure opportunities.
